...
try {
  ...
  node tools/test-topology-strategy.mjs
  if ($LASTEXITCODE -ne 0) {throw 'topology strategy fixtures failed'}
  node tools/test-connection-strategy.mjs
  if ($LASTEXITCODE -ne 0) {throw 'connection strategy fixtures failed'}
