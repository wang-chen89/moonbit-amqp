...
export function sourceSnapshot(paths) {
  if(paths.includes('tools/client.mjs')||paths.includes('tools/recovery-channel.mjs'))paths=['tools/recovery-control.mjs','tools/recovery.mjs','tools/recovery-state.mjs','tools/recovery-channel.mjs','tools/topology-query.mjs','tools/transport.mjs','connection_metadata.mbt','cmd/web/connection_metadata.mbt','tools/connection-metadata.mjs','tools/uri.mjs','uri.mbt','cmd/web/uri.mbt','tools/consumer-signal.mjs','tools/confirmations.mjs',...paths];
