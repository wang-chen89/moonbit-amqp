...
export function sourceSnapshot(paths) {
  if(paths.includes('tools/client.mjs')||paths.includes('tools/recovery-channel.mjs'))paths=['connection_metadata.mbt','cmd/web/connection_metadata.mbt','tools/connection-metadata.mjs','tools/uri.mjs','uri.mbt','cmd/web/uri.mbt','tools/consumer-signal.mjs','tools/confirmations.mjs',...paths];
