...
仍缺自定义 ConnectionRecovery/TopologyRecovery 策略、CloseDeadline、完整通知/Go context 调度、所有恢复交错、跨平台/多版本/集群和长期性能验证。已关闭通道重新进入原库恢复流程的全部边界没有验证；本库要求新建通道。本轮没有代表性原生吞吐或性能追平结论。
