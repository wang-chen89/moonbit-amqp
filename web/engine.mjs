...
_M0DTPC15error5Error41localreview_2famqp_2eFrameError_2eInvalid.prototype.$tag = 1;
...
function _M0TP211localreview4amqp9Assembler(param0, param1, param2, param3) {
  this.pending = param0;
  this.max_body = param1;
  this.buffered = param2;
  this.failed = param3;
}
...
function _M0MPC16option6Option6unwrapGUiiEE(self) {
  if (self === undefined) {
    return $panic();
  } else {
    const _Some = self;
...
function _M0MPB3Map20add__entry__to__tailGiRP211localreview4amqp7PendingE(self, idx, entry) {
  ...
  if (_bind === -1) {
    ...
    _M0MPC16option6Option6unwrapGUiiEE(_bind >>> 0 < _tmp.length ? _tmp[_bind] : $oob()).next = entry;
  }
  self.tail = idx;
...
function _M0MPB3Map13remove__entryGiRP211localreview4amqp7PendingE(self, entry) {
  ...
  if (_bind === -1) {
    ...
    const _tmp = self.entries;
    _M0MPC16option6Option6unwrapGUiiEE(_bind >>> 0 < _tmp.length ? _tmp[_bind] : $oob()).next = entry.next;
  }
  ...
  while (true) {
    ...
    if (_ < _bind) {
      ...
      if (self.buffer.length === self.expected && self.expected >= 8) {
        ...
        _M0MPC15array5Array4pushGsE(frames, frame);
...
function _M0MP211localreview4amqp9Assembler11new_2einner(max_body) {
  ...
  const _bind = [];
  return new _M0DTPC16result6ResultGRP211localreview4amqp9AssemblerRP211localreview4amqp10FrameErrorE2Ok(new _M0TP211localreview4amqp9Assembler(_M0MPB3Map3MapGiRP211localreview4amqp7PendingE(new _M0TPB9ArrayViewGUiRP211localreview4amqp7PendingEE(_bind, 0, 0), undefined), max_body, 0, false));
}
function _M0MP211localreview4amqp9Assembler4push(self, frame) {
  ...
  _L: {
    ...
    if (frame.kind === 1) {
      ...
      const ids = _M0MPC16option6Option6unwrapGUiiEE(_M0MP211localreview4amqp5Frame11method__ids(frame));
    ...
    if (frame.kind === 2) {
      ...
      if ((0 >>> 0 < bytes.length ? bytes[0] : $oob()) !== 0 || ((1 >>> 0 < bytes.length ? bytes[1] : $oob()) !== 60 || ((2 >>> 0 < bytes.length ? bytes[2] : $oob()) !== 0 || (3 >>> 0 < bytes.length ? bytes[3] : $oob()) !== 0))) {
        _err = new _M0DTPC15error5Error41localreview_2famqp_2eFrameError_2eInvalid("expected Basic class header with weight zero");
        break _L;
      }
      const size = new _M0TPB8MutLocalGmE(0n);
      const _bind$4 = 4;
      const _bind$5 = 12;
      let _tmp = _bind$4;
      while (true) {
        const i = _tmp;
        if (i < _bind$5) {
          size.val = BigInt.asUintN(64, BigInt.asUintN(64, size.val << BigInt(8 & 63)) | _M0MPC14byte4Byte10to__uint64(i >>> 0 < bytes.length ? bytes[i] : $oob()));
          _tmp = i + 1 | 0;
          continue;
        } else {
          break;
      ...
      if (BigInt.asUintN(64, size.val) > BigInt.asUintN(64, _M0MPC13int3Int10to__uint64(self.max_body))) {
        _err = new _M0DTPC15error5Error41localreview_2famqp_2eFrameError_2eInvalid("declared body exceeds limit");
        break _L;
      }
      state.expected = Number(BigInt.asIntN(32, size.val)) | 0;
      state.header = bytes;
      if (state.expected === 0) {
...
function _M0FP411localreview4amqp3cmd3web5unhex(text) {
  const out = [];
...
function _M0FP411localreview4amqp3cmd3web3run(input) {
  let _try_err;
  _L: {
    const _bind = "assemble:";
    const assemble = _M0MPC16string6String11has__prefix(input, new _M0TPC16string10StringView(_bind, 0, _bind.length));
    const _bind$2 = _M0FP411localreview4amqp3cmd3web5unhex(assemble ? _M0MPC16string10StringView9to__owned(_M0MPC16string6String11sub_2einner(input, 9, undefined)) : input);
    let data;
    if (_bind$2.$tag === 1) {
      const _ok = _bind$2;
      data = _ok._0;
    ...
    const _bind$4 = _M0MP211localreview4amqp7Decoder4feed(d, data);
    let frames;
    if (_bind$4.$tag === 1) {
      const _ok = _bind$4;
      frames = _ok._0;
    ...
    const _bind$5 = _M0MP211localreview4amqp7Decoder6finish(d);
    if (_bind$5.$tag === 1) {
      const _ok = _bind$5;
      _ok._0;
    } else {
    ...
    const lines = [];
    if (assemble) {
      const _bind$6 = _M0MP211localreview4amqp9Assembler11new_2einner(8388608);
      let assembler;
      if (_bind$6.$tag === 1) {
        const _ok = _bind$6;
        assembler = _ok._0;
      ...
      while (true) {
        ...
        if (_ < _bind$7) {
          ...
          _L$2: {
            ...
            _M0MPC15array5Array4pushGsE(lines, `${_M0IP016_24default__implPB4Show10to__stringGRPC15debug4ReprE(_M0MPC15debug4Repr4ReprGRP211localreview4amqp7ContentE(content))}\nBody hex: ${_M0FP411localreview4amqp3cmd3web3hex(content.body)}`);
          }
          _tmp = _ + 1 | 0;
          continue;
        } else {
    ...
    while (true) {
      ...
      if (_ < _bind$6) {
        ...
        const _bind$7 = _M0MP211localreview4amqp5Frame14encode_2einner(frame, 131072);
        let _tmp$3;
        if (_bind$7.$tag === 1) {
          const _ok = _bind$7;
          _tmp$3 = _ok._0;
    ...
    const _bind$7 = "\n\n";
    return _M0MPC15array5Array4joinGsE(lines, new _M0TPC16string10StringView(_bind$7, 0, _bind$7.length));
  }
  const e = _try_err;
...
export { _M0FP411localreview4amqp3cmd3web3run as run }
